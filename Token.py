...
OBOYUDNO_KEYWORDS: dict[str, TokenType] = {
    ...
    "tralalero_tralala": TokenType.VAR,
    "burbaloni_luliloli": TokenType.VAR,
    "bombordini_gusini": TokenType.VAR,
    "lirirliri_larila": TokenType.VAR,
    "chimpanzizni_banannini": TokenType.VAR,
    "brr_brr_patapim": TokenType.VAR,
    "frulli_frulaa": TokenType.VAR,
    "tigrini_watermellini": TokenType.VAR,
    "tung_tung_tung_tung_sahur": TokenType.VAR,
    "🤙": TokenType.COLON,
    ...
    "A_din_din_dun_dun_ma_din_din_din_din": TokenType.WHILE,
    "dlya": TokenType.FOR,
    "blya": TokenType.FOR,
